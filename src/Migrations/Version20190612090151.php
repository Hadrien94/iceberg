 ...
 */
final class Version20190612090151 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE user_id user_id_id INT NOT NULL');
